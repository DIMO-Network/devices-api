// Package docs Code generated by swaggo/swag at 2024-04-09 20:10:34.024936 -0400 EDT m=+2.062431085. DO NOT EDIT
package docs
    ...
    "paths": {
        ...
        "/user/devices/{userDeviceID}/range": {
            "get": {
                ...
                "tags": [
                    "user-devices [End Of Life Warning]"
                ],
                "parameters": [
                    {
                        "type": "string",
        ...
        "/v2/vehicles/{tokenId}/analytics/range": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
