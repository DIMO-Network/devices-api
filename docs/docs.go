...
// 2024-03-26 15:36:35.329821 -0600 MDT m=+2.443960418
package docs
...
const docTemplate = `{
        ...
        "/aftermarket/device/by-serial/:serial": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "autopi unit id or macaron serial",
                        "name": "serial",
                        "in": "path",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/constants.CountryInfo"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/helpers.CreateResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.AutoPiDeviceInfo": {
            ...
            "properties": {
                ...
                "claim": {
                    ...
                    "$ref": "#/definitions/github.com_DIMO-Network_devices-api_internal_controllers.AutoPiTransactionStatus"
                },
                "deviceId": {
                    "type": "string"
                },
                ...
                "manufacturer": {
                    "$ref": "#/definitions/github.com_DIMO-Network_devices-api_internal_controllers.ManufacturerInfo"
                },
                "ownerAddress": {
                    "type": "string"
                },
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.AutoPiPairRequest": {
            "type": "object",
            "properties": {
                "aftermarketDeviceSignature": {
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.AutoPiTransactionStatus": {
            "type": "object",
            "properties": {
                "createdAt": {
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.BurnRequest": {
            "type": "object",
            "required": [
                "signature"
            ],
        ...
        "github.com_DIMO-Network_devices-api_internal_controllers.BurnSyntheticDeviceRequest": {
            "type": "object",
            "properties": {
                "signature": {
                    "type": "string"
        ...
        "services.DeviceDefinition": {
            ...
            "properties": {
                ...
                "deviceAttributes": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.DeviceAttribute"
                    }
                },
                "deviceDefinitionId": {
                    "type": "string"
