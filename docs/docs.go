// Code generated by swaggo/swag at 2023-04-13 22:47:27.000275 -0400 EDT m=+2.262359834. DO NOT EDIT
package docs
    ...
    "paths": {
        ...
        "/user/devices/fromsmartcar": {
            "post": {
                ...
                "description": "adds a device to a user by decoding VIN from Smartcar. If cannot decode returns 424 or 500 if error.\nIf the user device already exists from a different integration, for the same user, this will return a 200 with the full user device",
                "consumes": [
                    "application/json"
                ],
                "produces": [
