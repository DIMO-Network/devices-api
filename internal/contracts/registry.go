...
// MintVehicleAndSdWithDeviceDefinitionSign is a paid mutator transaction binding the contract method 0xdfcdf33c.
//
// Solidity: function mintVehicleAndSdWithDeviceDefinitionSign((uint256,address,string,(string,string)[],uint256,bytes,bytes,address,(string,string)[]) data, (address,uint256,uint256,string) sacdInput) returns()
func (_Registry *RegistryTransactor) MintVehicleAndSdWithDeviceDefinitionSign(opts *bind.TransactOpts, data MintVehicleAndSdWithDdInput, sacdInput SacdInput) (*types.Transaction, error) {
	return _Registry.contract.Transact(opts, "mintVehicleAndSdWithDeviceDefinitionSign", data, sacdInput)
}

// MintVehicleAndSdWithDeviceDefinitionSign is a paid mutator transaction binding the contract method 0xdfcdf33c.
//
// Solidity: function mintVehicleAndSdWithDeviceDefinitionSign((uint256,address,string,(string,string)[],uint256,bytes,bytes,address,(string,string)[]) data, (address,uint256,uint256,string) sacdInput) returns()
func (_Registry *RegistrySession) MintVehicleAndSdWithDeviceDefinitionSign(data MintVehicleAndSdWithDdInput, sacdInput SacdInput) (*types.Transaction, error) {
	return _Registry.Contract.MintVehicleAndSdWithDeviceDefinitionSign(&_Registry.TransactOpts, data, sacdInput)
}

// MintVehicleAndSdWithDeviceDefinitionSign is a paid mutator transaction binding the contract method 0xdfcdf33c.
//
// Solidity: function mintVehicleAndSdWithDeviceDefinitionSign((uint256,address,string,(string,string)[],uint256,bytes,bytes,address,(string,string)[]) data, (address,uint256,uint256,string) sacdInput) returns()
func (_Registry *RegistryTransactorSession) MintVehicleAndSdWithDeviceDefinitionSign(data MintVehicleAndSdWithDdInput, sacdInput SacdInput) (*types.Transaction, error) {
	return _Registry.Contract.MintVehicleAndSdWithDeviceDefinitionSign(&_Registry.TransactOpts, data, sacdInput)
}
