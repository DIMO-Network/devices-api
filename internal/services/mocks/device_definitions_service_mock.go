...
// Source: ./internal/services/device_definitions_service.go
//
// Generated by this command:
//
// mockgen -source ./internal/services/device_definitions_service.go -destination ./internal/services/mocks/device_definitions_service_mock.go
//
...
// GetDeviceDefinitionByMMY mocks base method.
func (m *MockDeviceDefinitionService) GetDeviceDefinitionByMMY(ctx context.Context, year int32, make, model string) (*grpc.GetDeviceDefinitionItemResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeviceDefinitionByMMY", ctx, year, make, model)
	ret0, _ := ret[0].(*grpc.GetDeviceDefinitionItemResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDeviceDefinitionByMMY indicates an expected call of GetDeviceDefinitionByMMY.
func (mr *MockDeviceDefinitionServiceMockRecorder) GetDeviceDefinitionByMMY(ctx, year, make, model interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDeviceDefinitionByMMY", reflect.TypeOf((*MockDeviceDefinitionService)(nil).GetDeviceDefinitionByMMY), ctx, year, make, model)
}
