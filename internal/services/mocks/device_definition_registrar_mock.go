...
//
//	mockgen -source device_definition_registrar.go -destination mocks/device_definition_registrar_mock.go
//
...
func (mr *MockDeviceDefinitionRegistrarMockRecorder) Register(d any) *gomock.Call {
