...
// Source: internal/services/tesla_task_service.go
//
// Generated by this command:
//
//	mockgen -source=internal/services/tesla_task_service.go -destination=internal/services/mocks/tesla_task_service_mock.go
//
...
func (m *MockTeslaTaskService) StartPoll(vehicle *services.TeslaVehicle, udai *models.UserDeviceAPIIntegration, apiVersion int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StartPoll", vehicle, udai, apiVersion)
	ret0, _ := ret[0].(error)
	return ret0
}

// StartPoll indicates an expected call of StartPoll.
func (mr *MockTeslaTaskServiceMockRecorder) StartPoll(vehicle, udai, apiVersion any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StartPoll", reflect.TypeOf((*MockTeslaTaskService)(nil).StartPoll), vehicle, udai, apiVersion)
}
