...
func (mr *MockValuationsAPIServiceMockRecorder) GetUserDeviceOffers(ctx, userDeviceID any) *gomock.Call {
...
func (mr *MockValuationsAPIServiceMockRecorder) GetUserDeviceValuations(ctx, userDeviceID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
