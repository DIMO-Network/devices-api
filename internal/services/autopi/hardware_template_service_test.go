	...
	for _, scenario := range []tableTestCases{
		{
			...
			ud: &models.UserDevice{
				ID:            ksuid.New().String(),
				UserID:        "testUserID",
				DefinitionID:  ddWithDeviceStyleInUD.Id,
		...
		},
		{
			...
			ud: &models.UserDevice{
				ID:           ksuid.New().String(),
				UserID:       "testUserID",
				DefinitionID: ddWithDeviceStyleTID.Id,
				CountryCode:  null.StringFrom("USA"),
				Name:         null.StringFrom("Chungus"),
			},
			integ:    integration,
