...
func (s *UserDevicesControllerTestSuite) SetupSuite() {
	...
	c := NewUserDevicesController(&config.Settings{Port: "3000", Environment: "prod", CompassPreSharedKey: "psk-compass"}, s.pdb.DBS, logger, s.deviceDefSvc, s.deviceDefIntSvc, &fakeEventService{}, s.scClient, s.scTaskSvc, teslaSvc, teslaTaskService, nil, new(shared.ROT13Cipher), s.autoPiSvc,
