...
CREATE TABLE synthetic_devices (
    ...
    PRIMARY KEY (token_id, integration_id),
    CONSTRAINT fkey_vehicle_token_id FOREIGN KEY (token_id) REFERENCES vehicle_nfts(token_id),
...
DROP TABLE synthetic_devices_serial_sequence;
-- +goose StatementEnd
