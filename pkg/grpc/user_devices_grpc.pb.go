...
type UserDeviceServiceClient interface {
	...
	IssueVinCredential(ctx context.Context, in *VinCredentialRequest, opts ...grpc.CallOption) (*VinCredentialResponse, error)
}
...
func (c *userDeviceServiceClient) IssueVinCredential(ctx context.Context, in *VinCredentialRequest, opts ...grpc.CallOption) (*VinCredentialResponse, error) {
	out := new(VinCredentialResponse)
...
type UserDeviceServiceServer interface {
	...
	IssueVinCredential(context.Context, *VinCredentialRequest) (*VinCredentialResponse, error)
...
func (UnimplementedUserDeviceServiceServer) IssueVinCredential(context.Context, *VinCredentialRequest) (*VinCredentialResponse, error) {
...
func _UserDeviceService_IssueVinCredential_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserDeviceServiceServer).IssueVinCredential(ctx, req.(*VinCredentialRequest))
	}
	return interceptor(ctx, in, info, handler)
}
