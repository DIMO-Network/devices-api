...
const (
	...
	UserDeviceService_GetVehicleByTokenIdFast_FullMethodName       = "/devices.UserDeviceService/GetVehicleByTokenIdFast"
)
...
type UserDeviceServiceClient interface {
	...
	GetVehicleByTokenIdFast(ctx context.Context, in *GetVehicleByTokenIdFastRequest, opts ...grpc.CallOption) (*GetVehicleByTokenIdFastResponse, error)
}
...
func (c *userDeviceServiceClient) GetVehicleByTokenIdFast(ctx context.Context, in *GetVehicleByTokenIdFastRequest, opts ...grpc.CallOption) (*GetVehicleByTokenIdFastResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetVehicleByTokenIdFastResponse)
	err := c.cc.Invoke(ctx, UserDeviceService_GetVehicleByTokenIdFast_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserDeviceServiceServer interface {
	...
	GetVehicleByTokenIdFast(context.Context, *GetVehicleByTokenIdFastRequest) (*GetVehicleByTokenIdFastResponse, error)
...
func (UnimplementedUserDeviceServiceServer) GetVehicleByTokenIdFast(context.Context, *GetVehicleByTokenIdFastRequest) (*GetVehicleByTokenIdFastResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetVehicleByTokenIdFast not implemented")
}
...
func _UserDeviceService_GetVehicleByTokenIdFast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVehicleByTokenIdFastRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserDeviceServiceServer).GetVehicleByTokenIdFast(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserDeviceService_GetVehicleByTokenIdFast_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserDeviceServiceServer).GetVehicleByTokenIdFast(ctx, req.(*GetVehicleByTokenIdFastRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserDeviceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetVehicleByTokenIdFast",
			Handler:    _UserDeviceService_GetVehicleByTokenIdFast_Handler,
		},
	},
