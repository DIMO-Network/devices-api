...
type GetAllUserDeviceResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetAllUserDeviceResponse) Reset() {
	*x = GetAllUserDeviceResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAllUserDeviceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllUserDeviceResponse) ProtoMessage() {}

func (x *GetAllUserDeviceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_grpc_user_devices_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllUserDeviceResponse.ProtoReflect.Descriptor instead.
func (*GetAllUserDeviceResponse) Descriptor() ([]byte, []int) {
	return file_pkg_grpc_user_devices_proto_rawDescGZIP(), []int{19}
}

func (x *GetAllUserDeviceResponse) GetUserDevices() []*UserDevice {
	if x != nil {
		return x.UserDevices
	}
	return nil
...
var file_pkg_grpc_user_devices_proto_rawDesc = []byte{
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x77, 0x6d, 0x69, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x77, 0x6d, 0x69, 0x22, 0x52, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x41,
	0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70,
	...
	0x0b, 0x75, 0x73, 0x65, 0x72, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x32, 0x9f, 0x08, 0x0a,
	...
	0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x57, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x55,
...
var file_pkg_grpc_user_devices_proto_goTypes = []interface{}{
	...
	(*GetAllUserDeviceRequest)(nil),              // 18: devices.GetAllUserDeviceRequest
	(*GetAllUserDeviceResponse)(nil),             // 19: devices.GetAllUserDeviceResponse
...
var file_pkg_grpc_user_devices_proto_depIdxs = []int32{
	...
	4,  // 5: devices.GetAllUserDeviceResponse.user_devices:type_name -> devices.UserDevice
	...
	21, // 10: devices.UserDeviceService.GetAllUserDeviceValuation:input_type -> google.protobuf.Empty
	0,  // 11: devices.UserDeviceService.GetUserDeviceByAutoPIUnitId:input_type -> devices.GetUserDeviceByAutoPIUnitIdRequest
	21, // 12: devices.UserDeviceService.GetClaimedVehiclesGrowth:input_type -> google.protobuf.Empty
	...
	18, // 16: devices.UserDeviceService.GetAllUserDevice:input_type -> devices.GetAllUserDeviceRequest
	...
	19, // 27: devices.UserDeviceService.GetAllUserDevice:output_type -> devices.GetAllUserDeviceResponse
...
func file_pkg_grpc_user_devices_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_grpc_user_devices_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllUserDeviceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
