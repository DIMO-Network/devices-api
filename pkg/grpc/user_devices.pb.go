...
var file_pkg_grpc_user_devices_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x32, 0xe1, 0x06, 0x0a, 0x11, 0x55,
	...
	0x4f, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x1a, 0x1a, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x56,
	...
	0x72, 0x6f, 0x6d, 0x56, 0x49, 0x4e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2e,
...
var file_pkg_grpc_user_devices_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
...
var file_pkg_grpc_user_devices_proto_depIdxs = []int32{
	16, // 0: devices.UserDevice.opted_in_at:type_name -> google.protobuf.Timestamp
	...
	1,  // 3: devices.UserDeviceService.GetUserDevice:input_type -> devices.GetUserDeviceRequest
	2,  // 4: devices.UserDeviceService.GetUserDeviceByTokenId:input_type -> devices.GetUserDeviceByTokenIdRequest
	7,  // 5: devices.UserDeviceService.ListUserDevicesForUser:input_type -> devices.ListUserDevicesForUserRequest
	9,  // 6: devices.UserDeviceService.ApplyHardwareTemplate:input_type -> devices.ApplyHardwareTemplateRequest
	17, // 7: devices.UserDeviceService.GetAllUserDeviceValuation:input_type -> google.protobuf.Empty
	0,  // 8: devices.UserDeviceService.GetUserDeviceByAutoPIUnitId:input_type -> devices.GetUserDeviceByAutoPIUnitIdRequest
	17, // 9: devices.UserDeviceService.GetClaimedVehiclesGrowth:input_type -> google.protobuf.Empty
	12, // 10: devices.UserDeviceService.CreateTemplate:input_type -> devices.CreateTemplateRequest
	14, // 11: devices.UserDeviceService.RegisterUserDeviceFromVIN:input_type -> devices.RegisterUserDeviceFromVINRequest
	4,  // 12: devices.UserDeviceService.GetUserDevice:output_type -> devices.UserDevice
	4,  // 13: devices.UserDeviceService.GetUserDeviceByTokenId:output_type -> devices.UserDevice
	8,  // 14: devices.UserDeviceService.ListUserDevicesForUser:output_type -> devices.ListUserDevicesForUserResponse
	10, // 15: devices.UserDeviceService.ApplyHardwareTemplate:output_type -> devices.ApplyHardwareTemplateResponse
	3,  // 16: devices.UserDeviceService.GetAllUserDeviceValuation:output_type -> devices.ValuationResponse
	6,  // 17: devices.UserDeviceService.GetUserDeviceByAutoPIUnitId:output_type -> devices.UserDeviceAutoPIUnitResponse
	11, // 18: devices.UserDeviceService.GetClaimedVehiclesGrowth:output_type -> devices.ClaimedVehiclesGrowth
	13, // 19: devices.UserDeviceService.CreateTemplate:output_type -> devices.CreateTemplateResponse
	15, // 20: devices.UserDeviceService.RegisterUserDeviceFromVIN:output_type -> devices.RegisterUserDeviceFromVINResponse
