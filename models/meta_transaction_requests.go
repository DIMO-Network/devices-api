...
var MetaTransactionRequestRels = struct {
	...
	BurnRequestUserDevice                        string
	MintRequestUserDevice                        string
}{
	...
	BurnRequestUserDevice:                        "BurnRequestUserDevice",
	MintRequestUserDevice:                        "MintRequestUserDevice",
}
...
type metaTransactionRequestR struct {
	...
	BurnRequestUserDevice                        *UserDevice        `boil:"BurnRequestUserDevice" json:"BurnRequestUserDevice" toml:"BurnRequestUserDevice" yaml:"BurnRequestUserDevice"`
	MintRequestUserDevice                        *UserDevice        `boil:"MintRequestUserDevice" json:"MintRequestUserDevice" toml:"MintRequestUserDevice" yaml:"MintRequestUserDevice"`
}
...
func (o *MetaTransactionRequest) GetClaimMetaTransactionRequestAftermarketDevice() *AftermarketDevice {
	if o == nil {
		return nil
	}

	return o.R.GetClaimMetaTransactionRequestAftermarketDevice()
}
...
func (o *MetaTransactionRequest) GetPairRequestAftermarketDevice() *AftermarketDevice {
	if o == nil {
		return nil
	}

	return o.R.GetPairRequestAftermarketDevice()
}
...
func (o *MetaTransactionRequest) GetUnpairRequestAftermarketDevice() *AftermarketDevice {
	if o == nil {
		return nil
	}

	return o.R.GetUnpairRequestAftermarketDevice()
}
...
func (o *MetaTransactionRequest) GetMintRequestSyntheticDevice() *SyntheticDevice {
	if o == nil {
		return nil
	}

	return o.R.GetMintRequestSyntheticDevice()
}
...
func (o *MetaTransactionRequest) GetBurnRequestSyntheticDevice() *SyntheticDevice {
	if o == nil {
		return nil
	}

	return o.R.GetBurnRequestSyntheticDevice()
}

func (r *metaTransactionRequestR) GetBurnRequestSyntheticDevice() *SyntheticDevice {
	if r == nil {
		return nil
	}
...
func (o *MetaTransactionRequest) GetBurnRequestUserDevice() *UserDevice {
	if o == nil {
		return nil
	}

	return o.R.GetBurnRequestUserDevice()
}

func (r *metaTransactionRequestR) GetBurnRequestUserDevice() *UserDevice {
	if r == nil {
		return nil
	}

	return r.BurnRequestUserDevice
}

func (o *MetaTransactionRequest) GetMintRequestUserDevice() *UserDevice {
	if o == nil {
		return nil
	}

	return o.R.GetMintRequestUserDevice()
}

func (r *metaTransactionRequestR) GetMintRequestUserDevice() *UserDevice {
	if r == nil {
		return nil
	}

	return r.MintRequestUserDevice
}
...
// BurnRequestSyntheticDevice pointed to by the foreign key.
func (o *MetaTransactionRequest) BurnRequestSyntheticDevice(mods ...qm.QueryMod) syntheticDeviceQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"burn_request_id\" = ?", o.ID),
	}
...
// BurnRequestUserDevice pointed to by the foreign key.
func (o *MetaTransactionRequest) BurnRequestUserDevice(mods ...qm.QueryMod) userDeviceQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"burn_request_id\" = ?", o.ID),
	}
...
// MintRequestUserDevice pointed to by the foreign key.
func (o *MetaTransactionRequest) MintRequestUserDevice(mods ...qm.QueryMod) userDeviceQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"mint_request_id\" = ?", o.ID),
	}
...
func (metaTransactionRequestL) LoadClaimMetaTransactionRequestAftermarketDevice(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMetaTransactionRequest interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`devices_api.aftermarket_devices.claim_meta_transaction_request_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (metaTransactionRequestL) LoadPairRequestAftermarketDevice(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMetaTransactionRequest interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`devices_api.aftermarket_devices`),
		qm.WhereIn(`devices_api.aftermarket_devices.pair_request_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (metaTransactionRequestL) LoadUnpairRequestAftermarketDevice(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMetaTransactionRequest interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`devices_api.aftermarket_devices`),
		qm.WhereIn(`devices_api.aftermarket_devices.unpair_request_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (metaTransactionRequestL) LoadMintRequestSyntheticDevice(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMetaTransactionRequest interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`devices_api.synthetic_devices.mint_request_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadBurnRequestSyntheticDevice allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (metaTransactionRequestL) LoadBurnRequestSyntheticDevice(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMetaTransactionRequest interface{}, mods queries.Applicator) error {
	var slice []*MetaTransactionRequest
	var object *MetaTransactionRequest
	...
	query := NewQuery(
		qm.From(`devices_api.synthetic_devices`),
		qm.WhereIn(`devices_api.synthetic_devices.burn_request_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		foreign := resultSlice[0]
		object.R.BurnRequestSyntheticDevice = foreign
		if foreign.R == nil {
			foreign.R = &syntheticDeviceR{}
		}
		foreign.R.BurnRequest = object
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ID, foreign.BurnRequestID) {
				local.R.BurnRequestSyntheticDevice = foreign
				if foreign.R == nil {
					foreign.R = &syntheticDeviceR{}
				}
				foreign.R.BurnRequest = local
				break
			}
		}
	}
...
// LoadBurnRequestUserDevice allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (metaTransactionRequestL) LoadBurnRequestUserDevice(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMetaTransactionRequest interface{}, mods queries.Applicator) error {
	var slice []*MetaTransactionRequest
	var object *MetaTransactionRequest
	...
	query := NewQuery(
		...
		qm.WhereIn(`devices_api.user_devices.burn_request_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		foreign := resultSlice[0]
		object.R.BurnRequestUserDevice = foreign
		if foreign.R == nil {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ID, foreign.BurnRequestID) {
				local.R.BurnRequestUserDevice = foreign
				if foreign.R == nil {
					foreign.R = &userDeviceR{}
				}
				foreign.R.BurnRequest = local
...
// LoadMintRequestUserDevice allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (metaTransactionRequestL) LoadMintRequestUserDevice(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMetaTransactionRequest interface{}, mods queries.Applicator) error {
	var slice []*MetaTransactionRequest
	var object *MetaTransactionRequest
	...
	query := NewQuery(
		qm.From(`devices_api.user_devices`),
		qm.WhereIn(`devices_api.user_devices.mint_request_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		foreign := resultSlice[0]
		object.R.MintRequestUserDevice = foreign
		if foreign.R == nil {
			foreign.R = &userDeviceR{}
		}
		foreign.R.MintRequest = object
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ID, foreign.MintRequestID) {
				local.R.MintRequestUserDevice = foreign
				if foreign.R == nil {
					foreign.R = &userDeviceR{}
				}
				foreign.R.MintRequest = local
...
// SetBurnRequestSyntheticDevice of the metaTransactionRequest to the related item.
// Sets o.R.BurnRequestSyntheticDevice to related.
// Adds o to related.R.BurnRequest.
func (o *MetaTransactionRequest) SetBurnRequestSyntheticDevice(ctx context.Context, exec boil.ContextExecutor, insert bool, related *SyntheticDevice) error {
	var err error

	if insert {
		queries.Assign(&related.BurnRequestID, o.ID)
	...
	if o.R == nil {
		o.R = &metaTransactionRequestR{
			BurnRequestSyntheticDevice: related,
		}
	} else {
		o.R.BurnRequestSyntheticDevice = related
	}
	...
	if related.R == nil {
		...
		related.R.BurnRequest = o
	}
	return nil
}

// RemoveBurnRequestSyntheticDevice relationship.
// Sets o.R.BurnRequestSyntheticDevice to nil.
// Removes o from all passed in related items' relationships struct.
func (o *MetaTransactionRequest) RemoveBurnRequestSyntheticDevice(ctx context.Context, exec boil.ContextExecutor, related *SyntheticDevice) error {
	var err error

	queries.SetScanner(&related.BurnRequestID, nil)
	if _, err = related.Update(ctx, exec, boil.Whitelist("burn_request_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}

	if o.R != nil {
		o.R.BurnRequestSyntheticDevice = nil
	}
	...
	related.R.BurnRequest = nil

	return nil
}

// SetBurnRequestUserDevice of the metaTransactionRequest to the related item.
// Sets o.R.BurnRequestUserDevice to related.
// Adds o to related.R.BurnRequest.
func (o *MetaTransactionRequest) SetBurnRequestUserDevice(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserDevice) error {
	var err error
	...
	if o.R == nil {
		o.R = &metaTransactionRequestR{
			BurnRequestUserDevice: related,
		}
	} else {
		o.R.BurnRequestUserDevice = related
	}
...
// RemoveBurnRequestUserDevice relationship.
// Sets o.R.BurnRequestUserDevice to nil.
// Removes o from all passed in related items' relationships struct.
func (o *MetaTransactionRequest) RemoveBurnRequestUserDevice(ctx context.Context, exec boil.ContextExecutor, related *UserDevice) error {
	var err error
...
// SetMintRequestUserDevice of the metaTransactionRequest to the related item.
// Sets o.R.MintRequestUserDevice to related.
// Adds o to related.R.MintRequest.
func (o *MetaTransactionRequest) SetMintRequestUserDevice(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserDevice) error {
	var err error

	if insert {
		queries.Assign(&related.MintRequestID, o.ID)
	...
	if o.R == nil {
		o.R = &metaTransactionRequestR{
			MintRequestUserDevice: related,
		}
	} else {
		o.R.MintRequestUserDevice = related
	}
...
// RemoveMintRequestUserDevice relationship.
// Sets o.R.MintRequestUserDevice to nil.
// Removes o from all passed in related items' relationships struct.
func (o *MetaTransactionRequest) RemoveMintRequestUserDevice(ctx context.Context, exec boil.ContextExecutor, related *UserDevice) error {
	var err error

	queries.SetScanner(&related.MintRequestID, nil)
	if _, err = related.Update(ctx, exec, boil.Whitelist("mint_request_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}

	if o.R != nil {
		o.R.MintRequestUserDevice = nil
	}
