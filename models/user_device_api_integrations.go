...
func (o *UserDeviceAPIIntegration) GetUserDevice() *UserDevice {
	if o == nil {
		return nil
	}
...
func (o *UserDeviceAPIIntegration) GetSerialAftermarketDevice() *AftermarketDevice {
	if o == nil {
		return nil
	}

	return o.R.GetSerialAftermarketDevice()
}
