...
func (o *UserDevice) GetBurnRequest() *MetaTransactionRequest {
	if o == nil {
		return nil
	}

	return o.R.GetBurnRequest()
}
...
func (o *UserDevice) GetMintRequest() *MetaTransactionRequest {
	if o == nil {
		return nil
	}

	return o.R.GetMintRequest()
}
...
func (o *UserDevice) GetVehicleTokenAftermarketDevice() *AftermarketDevice {
	if o == nil {
		return nil
	}

	return o.R.GetVehicleTokenAftermarketDevice()
}
...
func (o *UserDevice) GetVehicleTokenSyntheticDevice() *SyntheticDevice {
	if o == nil {
		return nil
	}

	return o.R.GetVehicleTokenSyntheticDevice()
}
...
func (o *UserDevice) GetAutopiJobs() AutopiJobSlice {
	if o == nil {
		return nil
	}

	return o.R.GetAutopiJobs()
}
...
func (o *UserDevice) GetDeviceCommandRequests() DeviceCommandRequestSlice {
	if o == nil {
		return nil
	}

	return o.R.GetDeviceCommandRequests()
}
...
func (o *UserDevice) GetErrorCodeQueries() ErrorCodeQuerySlice {
	if o == nil {
		return nil
	}

	return o.R.GetErrorCodeQueries()
}
...
func (o *UserDevice) GetVehicleTokenErrorCodeQueries() ErrorCodeQuerySlice {
	if o == nil {
		return nil
	}

	return o.R.GetVehicleTokenErrorCodeQueries()
}
...
func (o *UserDevice) GetUserDeviceAPIIntegrations() UserDeviceAPIIntegrationSlice {
	if o == nil {
		return nil
	}

	return o.R.GetUserDeviceAPIIntegrations()
}
...
var (
	userDeviceAllColumns            = []string{"id", "user_id", "vin_identifier", "name", "custom_image_url", "country_code", "created_at", "updated_at", "vin_confirmed", "metadata", "device_style_id", "opted_in_at", "mint_request_id", "burn_request_id", "token_id", "owner_address", "ipfs_image_cid", "definition_id"}
	userDeviceColumnsWithoutDefault = []string{"id", "user_id", "definition_id"}
