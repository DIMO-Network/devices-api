...
type UserDevice struct {
	...
	IpfsCid            null.String       `boil:"ipfs_cid" json:"ipfs_cid,omitempty" toml:"ipfs_cid" yaml:"ipfs_cid,omitempty"`
...
var UserDeviceWhere = struct {
	...
	IpfsCid            whereHelpernull_String
}{
	...
	IpfsCid:            whereHelpernull_String{field: "\"devices_api\".\"user_devices\".\"ipfs_cid\""},
}
...
var (
	userDeviceAllColumns            = []string{"id", "user_id", "device_definition_id", "vin_identifier", "name", "custom_image_url", "country_code", "created_at", "updated_at", "vin_confirmed", "metadata", "device_style_id", "opted_in_at", "mint_request_id", "burn_request_id", "token_id", "claim_id", "owner_address", "ipfs_cid"}
	userDeviceColumnsWithoutDefault = []string{"id", "user_id", "device_definition_id"}
	userDeviceColumnsWithDefault    = []string{"vin_identifier", "name", "custom_image_url", "country_code", "created_at", "updated_at", "vin_confirmed", "metadata", "device_style_id", "opted_in_at", "mint_request_id", "burn_request_id", "token_id", "claim_id", "owner_address", "ipfs_cid"}
...
func (userDeviceL) LoadMintRequest(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserDevice interface{}, mods queries.Applicator) error {
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if queries.Equal(a, obj.MintRequestID) {
					continue Outer
				}
			}
...
func (userDeviceL) LoadUserDeviceAPIIntegrations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserDevice interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`devices_api.user_device_api_integrations.user_device_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
